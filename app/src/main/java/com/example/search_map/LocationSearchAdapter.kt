...
class LocationSearchAdapter(private val locations: MutableList<String>?, private val clickListener: SearchItemClickListener) : RecyclerView.Adapter<LocationSearchAdapter.SearchViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SearchViewHolder {
        val textView = LayoutInflater.from(parent.context)
            .inflate(R.layout.search_list_item, parent, false) as TextView
